  ...
  return (
    <div className="max-w-3xl mx-auto px-5 sm:px-8 py-16 sm:py-24">
      ...
      <div className="space-y-8 text-paper/75 text-sm sm:text-base leading-relaxed">
        <section>
          <p>
            1. This document is an electronic record in terms of Information Technology Act, 2000 and
        ...
        <section>
          <p>
            ...
            applicable) (collectively, 'Services'). Any terms and conditions proposed by You which are in
            addition to or which conflict with these Terms of Use are expressly rejected by the Platform
            Owner and shall be of no force or effect. These Terms of Use can be modified at any time
            without assigning any reason. It is your responsibility to periodically review these Terms of
        ...
        <section>
          <p>
            5. For the purpose of these Terms of Use, wherever the context so requires 'you', 'your' or
        ...
        <section>
          <h2 className="font-display text-xl uppercase text-paper mb-3">6. Agreement to Terms</h2>
          <p>
        ...
        <section>
          <h2 className="font-display text-xl uppercase text-paper mb-3">7. Terms of Use</h2>
          <p>
          ...
          <ol className="list-decimal list-inside mt-2 space-y-2">
            <li>
              ...
              acts done through the use of your registered account on the Platform.
            </li>
            <li>
            ...
            <li>
              ...
              in its contents. The contents includes and is not limited to the design, layout, look and
              graphics.
            </li>
            <li>
